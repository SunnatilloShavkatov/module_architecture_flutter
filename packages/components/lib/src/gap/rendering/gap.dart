...
class RenderGap extends RenderBox {
  ...
  double computeMinIntrinsicWidth(double height) =>
      _computeIntrinsicExtent(Axis.horizontal, () => super.computeMinIntrinsicWidth(height))!;

  @override
  double computeMaxIntrinsicWidth(double height) =>
      _computeIntrinsicExtent(Axis.horizontal, () => super.computeMaxIntrinsicWidth(height))!;

  @override
  double computeMinIntrinsicHeight(double width) =>
      _computeIntrinsicExtent(Axis.vertical, () => super.computeMinIntrinsicHeight(width))!;

  @override
  double computeMaxIntrinsicHeight(double width) =>
      _computeIntrinsicExtent(Axis.vertical, () => super.computeMaxIntrinsicHeight(width))!;
