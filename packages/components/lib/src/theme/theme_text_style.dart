...
class ThemeTextStyles extends ThemeExtension<ThemeTextStyles> {
  ...
  static const ThemeTextStyles light = ThemeTextStyles(
    appBarTitle: TextStyle(fontSize: 16, color: Color(0xFF0A0A0A), fontWeight: FontWeight.w600),
    buttonStyle: TextStyle(fontSize: 16, fontWeight: FontWeight.w600),
    defaultW500x14: TextStyle(fontSize: 14, color: Color(0xFF0A0A0A), fontWeight: FontWeight.w500),
    defaultW700x14: TextStyle(fontSize: 14, color: Color(0xFF0A0A0A), fontWeight: FontWeight.w700),
    inputHintStyle: TextStyle(fontSize: 14, color: Color(0xFF8C929F), fontWeight: FontWeight.w400),
    inputTitleStyle: TextStyle(fontSize: 12, color: Color(0xFF0A0A0A), fontWeight: FontWeight.w400),
    inputLabelStyle: TextStyle(fontSize: 16, color: Color(0xFF0A0A0A), fontWeight: FontWeight.w400),
    errorLabelStyle: TextStyle(fontSize: 14, color: Color(0xFF9F2B44), fontWeight: FontWeight.w400),
    defaultW600x20: TextStyle(fontSize: 20, color: Color(0xFF0A0A0A), fontWeight: FontWeight.w600),
    defaultW600x18: TextStyle(fontSize: 18, color: Color(0xFF0A0A0A), fontWeight: FontWeight.w600),
    defaultW700x12: TextStyle(fontSize: 12, color: Color(0xFF0A0A0A), fontWeight: FontWeight.w700),
    defaultW500x12: TextStyle(fontSize: 12, color: Color(0xFF0A0A0A), fontWeight: FontWeight.w500),
    defaultW600x14: TextStyle(fontSize: 14, color: Color(0xFF0A0A0A), fontWeight: FontWeight.w600),
    defaultW400x14: TextStyle(fontSize: 14, color: Color(0xFF0A0A0A), fontWeight: FontWeight.w400),
    defaultW700x16: TextStyle(fontSize: 16, color: Color(0xFF0A0A0A), fontWeight: FontWeight.w700),
    defaultW400x12: TextStyle(fontSize: 12, color: Color(0xFF0A0A0A), fontWeight: FontWeight.w400),
    defaultW600x16: TextStyle(fontSize: 16, color: Color(0xFF0A0A0A), fontWeight: FontWeight.w600),
    defaultW500x13: TextStyle(fontSize: 13, color: Color(0xFF0A0A0A), fontWeight: FontWeight.w500),
    defaultW700x24: TextStyle(fontSize: 24, color: Color(0xFF0A0A0A), fontWeight: FontWeight.w700),
    defaultW600x24: TextStyle(fontSize: 24, color: Color(0xFF0A0A0A), fontWeight: FontWeight.w600),
    defaultW500x18: TextStyle(fontSize: 18, color: Color(0xFF0A0A0A), fontWeight: FontWeight.w500),
    defaultW700x18: TextStyle(fontSize: 18, color: Color(0xFF0A0A0A), fontWeight: FontWeight.w700),
    defaultW400x16: TextStyle(fontSize: 16, color: Color(0xFF0A0A0A), fontWeight: FontWeight.w400),
    defaultW500x16: TextStyle(fontSize: 16, color: Color(0xFF0A0A0A), fontWeight: FontWeight.w500),
    defaultW500x24: TextStyle(fontSize: 24, color: Color(0xFF0A0A0A), fontWeight: FontWeight.w500),
  );
  static const ThemeTextStyles dark = ThemeTextStyles(
    appBarTitle: TextStyle(fontSize: 16, color: Colors.white, fontWeight: FontWeight.w600),
    buttonStyle: TextStyle(fontSize: 16, fontWeight: FontWeight.w600),
    defaultW500x14: TextStyle(fontSize: 14, color: Colors.white, fontWeight: FontWeight.w500),
    defaultW700x14: TextStyle(fontSize: 14, color: Colors.white, fontWeight: FontWeight.w700),
    inputHintStyle: TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.w400),
    inputTitleStyle: TextStyle(color: Colors.white, fontSize: 12, fontWeight: FontWeight.w400),
    inputLabelStyle: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w400),
    errorLabelStyle: TextStyle(color: Color(0xFF9F2B44), fontSize: 14, fontWeight: FontWeight.w400),
    defaultW600x20: TextStyle(fontSize: 20, color: Colors.white, fontWeight: FontWeight.w600),
    defaultW600x18: TextStyle(fontSize: 18, color: Colors.white, fontWeight: FontWeight.w600),
    defaultW700x12: TextStyle(fontSize: 12, color: Colors.white, fontWeight: FontWeight.w700),
    defaultW500x12: TextStyle(fontSize: 12, color: Colors.white, fontWeight: FontWeight.w500),
    defaultW600x14: TextStyle(fontSize: 14, color: Colors.white, fontWeight: FontWeight.w600),
    defaultW400x14: TextStyle(fontSize: 14, color: Colors.white, fontWeight: FontWeight.w400),
    defaultW700x16: TextStyle(fontSize: 16, color: Colors.white, fontWeight: FontWeight.w700),
    defaultW400x12: TextStyle(fontSize: 12, color: Colors.white, fontWeight: FontWeight.w400),
    defaultW600x16: TextStyle(fontSize: 16, color: Colors.white, fontWeight: FontWeight.w600),
    defaultW500x13: TextStyle(fontSize: 13, color: Colors.white, fontWeight: FontWeight.w500),
    defaultW700x24: TextStyle(fontSize: 24, color: Colors.white, fontWeight: FontWeight.w700),
    defaultW600x24: TextStyle(fontSize: 24, color: Colors.white, fontWeight: FontWeight.w600),
    defaultW700x18: TextStyle(fontSize: 18, color: Colors.white, fontWeight: FontWeight.w700),
    defaultW400x16: TextStyle(fontSize: 16, color: Colors.white, fontWeight: FontWeight.w400),
    defaultW500x16: TextStyle(fontSize: 16, color: Colors.white, fontWeight: FontWeight.w500),
    defaultW500x18: TextStyle(fontSize: 18, color: Colors.white, fontWeight: FontWeight.w500),
    defaultW500x24: TextStyle(fontSize: 24, color: Colors.white, fontWeight: FontWeight.w500),
  );
