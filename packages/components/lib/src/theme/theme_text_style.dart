...
class ThemeTextStyles extends ThemeExtension<ThemeTextStyles> {
  ...
  static const ThemeTextStyles light = ThemeTextStyles(
    appBarTitle: TextStyle(fontSize: 20, color: Colors.black, fontWeight: FontWeight.w600),
    buttonStyle: TextStyle(color: Colors.white, fontSize: 17, fontWeight: FontWeight.w600),
    regularBody: TextStyle(color: Colors.black, fontSize: 17, fontWeight: FontWeight.w400),
    regularCallout: TextStyle(color: Colors.black, fontSize: 16, fontWeight: FontWeight.w400),
    regularCaption1: TextStyle(color: Colors.black, fontSize: 12, fontWeight: FontWeight.w400),
    regularCaption2: TextStyle(color: Colors.black, fontSize: 11, fontWeight: FontWeight.w400),
    regularFootnote: TextStyle(color: Colors.black, fontSize: 13, fontWeight: FontWeight.w400),
    regularHeadline: TextStyle(color: Colors.black, fontSize: 17, fontWeight: FontWeight.w600),
    regularLargeTitle: TextStyle(color: Colors.black, fontSize: 34, fontWeight: FontWeight.w400),
    regularSubheadline: TextStyle(color: Colors.black, fontSize: 15, fontWeight: FontWeight.w400),
    regularTitle1: TextStyle(color: Colors.black, fontSize: 28, fontWeight: FontWeight.w400),
    regularTitle2: TextStyle(color: Colors.black, fontSize: 22, fontWeight: FontWeight.w400),
    regularTitle3: TextStyle(color: Colors.black, fontSize: 22, fontWeight: FontWeight.w400),
    bodyBody: TextStyle(color: Colors.black, fontSize: 17, fontWeight: FontWeight.w400),
    bodyCallout: TextStyle(color: Colors.black, fontSize: 16, fontWeight: FontWeight.w400),
    bodyCaption1: TextStyle(color: Colors.black, fontSize: 12, fontWeight: FontWeight.w400),
    bodyCaption2: TextStyle(color: Colors.black, fontSize: 11, fontWeight: FontWeight.w400),
    bodyFootnote: TextStyle(color: Colors.black, fontSize: 13, fontWeight: FontWeight.w400),
    bodyHeadline: TextStyle(color: Colors.black, fontSize: 17, fontWeight: FontWeight.w600),
    bodyLargeTitle: TextStyle(color: Colors.black, fontSize: 34, fontWeight: FontWeight.w400),
    bodySubheadline: TextStyle(color: Colors.black, fontSize: 15, fontWeight: FontWeight.w400),
    bodyTitle1: TextStyle(color: Colors.black, fontSize: 34, fontWeight: FontWeight.w400),
    bodyTitle2: TextStyle(color: Colors.black, fontSize: 28, fontWeight: FontWeight.w400),
    bodyTitle3: TextStyle(color: Colors.black, fontSize: 22, fontWeight: FontWeight.w400),
  );
  static const ThemeTextStyles dark = ThemeTextStyles(
    appBarTitle: TextStyle(fontSize: 20, height: 20 / 20, color: Colors.white, fontWeight: FontWeight.w700),
    buttonStyle: TextStyle(color: Colors.white, fontSize: 17, fontWeight: FontWeight.w600),
    regularBody: TextStyle(color: Colors.white, fontSize: 17, fontWeight: FontWeight.w400),
    regularCallout: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w400),
    regularCaption1: TextStyle(color: Colors.white, fontSize: 12, fontWeight: FontWeight.w400),
    regularCaption2: TextStyle(color: Colors.white, fontSize: 11, fontWeight: FontWeight.w400),
    regularFootnote: TextStyle(color: Colors.white, fontSize: 13, fontWeight: FontWeight.w400),
    regularHeadline: TextStyle(color: Colors.white, fontSize: 17, fontWeight: FontWeight.w600),
    regularLargeTitle: TextStyle(color: Colors.white, fontSize: 34, fontWeight: FontWeight.w400),
    regularSubheadline: TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.w400),
    regularTitle1: TextStyle(color: Colors.white, fontSize: 34, fontWeight: FontWeight.w400),
    regularTitle2: TextStyle(color: Colors.white, fontSize: 28, fontWeight: FontWeight.w400),
    regularTitle3: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.w400),
    bodyBody: TextStyle(color: Colors.white, fontSize: 17, fontWeight: FontWeight.w400),
    bodyCallout: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w400),
    bodyCaption1: TextStyle(color: Colors.white, fontSize: 12, fontWeight: FontWeight.w400),
    bodyCaption2: TextStyle(color: Colors.white, fontSize: 11, fontWeight: FontWeight.w400),
    bodyFootnote: TextStyle(color: Colors.white, fontSize: 13, fontWeight: FontWeight.w400),
    bodyHeadline: TextStyle(color: Colors.white, fontSize: 17, fontWeight: FontWeight.w600),
    bodyLargeTitle: TextStyle(color: Colors.white, fontSize: 34, fontWeight: FontWeight.w400),
    bodySubheadline: TextStyle(color: Colors.white, fontSize: 15, fontWeight: FontWeight.w400),
    bodyTitle1: TextStyle(color: Colors.white, fontSize: 34, fontWeight: FontWeight.w400),
    bodyTitle2: TextStyle(color: Colors.white, fontSize: 28, fontWeight: FontWeight.w400),
    bodyTitle3: TextStyle(color: Colors.white, fontSize: 22, fontWeight: FontWeight.w400),
  );
