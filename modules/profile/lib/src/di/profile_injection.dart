...
import 'package:profile/src/domain/usecases/get_more_data.dart';
...
final class ProfileInjection implements Injection {
  ...
  void registerDependencies({required Injector di}) {
    di
      /// page factories
      ..registerLazySingleton<PageFactory>(() => const ProfilePageFactory(), instanceName: InstanceNameKeys.profileFactory)
      /// data sources
      ...
      /// bloc
      ..registerFactory(() => ProfileBloc(di.get()));
  }
}
